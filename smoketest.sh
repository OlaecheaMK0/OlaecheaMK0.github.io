...
ROUTES=(/ /index.html /project-1.html /project-2.html /project-3.html /css/style.css /js/stars.js)
PASS=0
FAIL=0
...
for p in index.html project-1.html project-2.html project-3.html; do
  file="$(dirname "$0")/$p"
  if [[ ! -f "$file" ]]; then
